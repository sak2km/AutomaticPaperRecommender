...
public class JsonWorker {
	...
	public void generate(String inputFile, String outputFile, String overall) throws JSONException, IOException {
...
//			System.out.println(sCurrentLine);
			if(sCurrentLine.equals("Title: ") || sCurrentLine.equals("Title:"))
			{
//				System.out.println(" Cfbcfg ");
				...
				if(temp.equals("Abstract:") || temp.equals("Abstract: "))
				{
...
//		}
	...
	public void writeJsonFile(String outputFile, JSONArray Reviews) throws JSONException, IOException
	{
		JSONObject ProductInfo = new JSONObject();
		ProductInfo.put("Price", "");
		ProductInfo.put("ProductID", "B00007FHEN");
